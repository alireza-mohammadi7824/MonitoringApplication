        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RefreshIntervalMilliseconds = table.Column<int>(type: "int", nullable: false),
                    ...
                    RedisUsername = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RedisPassword = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RedisDbNumber = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MonitoredServiceId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DowntimeEvents_Services_MonitoredServiceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DowntimeEvents_MonitoredServiceId",
